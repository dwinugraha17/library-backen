...
class BookFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        $category = $this->faker->randomElement(['Teknologi', 'Novel', 'Sains', 'Sejarah', 'Bisnis', 'Psikologi']);
        
        return [
            'title' => ucwords($this->faker->words(3, true)), // "The Great Gatsby" style
            ...
            'cover_image' => 'https://loremflickr.com/300/450/book?lock=' . $this->faker->unique()->numberBetween(1, 10000),
